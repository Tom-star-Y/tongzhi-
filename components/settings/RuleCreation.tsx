  ...
  return (
    <div className="p-6 h-full overflow-auto">
      <Tabs defaultValue="create" className="w-full h-full flex flex-col">
        ...
        <TabsContent value="create" className="space-y-6 flex-1 overflow-auto">
          <Card className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    id="tagKey"
                    placeholder="例如：支付结果"
                    value={editingRule.tagKey || ""}
                    onChange={(e) => setEditingRule({ ...editingRule, tagKey: e.target.value })}
                  />
                </div>
                <div>
              ...
              {editingRule.notifications?.map((notification, index) => (
                <div key={index} className="flex gap-3 items-start">
                  <Select
                    ...
                    onValueChange={(value) => updateNotificationChannel(index, "type", value)}
                  >
